...
<template>
  ...
  <section v-else-if="currentList.length === 0" class="py-24">
    <div class="container mx-auto px-6 text-center">
      <div class="w-16 h-16 rounded-full bg-gray-50 text-gray-400 flex items-center justify-center mx-auto mb-4">
  ...
  <section v-else class="py-10">
    <div class="container mx-auto px-6">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        >
          <div
            class="group relative bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl hover:shadow-blue-600/5 hover:-translate-y-1 transition-all duration-500 flex flex-col"
          >
            <!-- Cover -->
            <div class="relative h-36 bg-gradient-to-br from-slate-50 to-blue-50/50 overflow-hidden">
              ...
              <div v-else class="w-full h-full flex items-center justify-center">
                <div class="w-14 h-14 rounded-2xl bg-white/80 shadow-sm flex items-center justify-center">
                  <span :class="[getTypeTag(item.resourceType).icon, 'text-2xl text-blue-400']" />
                </div>
              </div>
              ...
              >
                <span :class="[getTypeTag(item.resourceType).icon, 'text-[9px]']" />
