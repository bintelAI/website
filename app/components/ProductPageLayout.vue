...
<template>
  <div class="min-h-screen bg-white">
      ...
      <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="flex flex-col md:flex-row gap-12 items-center">
          <div class="md:w-1/2 text-center md:text-left flex flex-col items-center md:items-start">
            ...
            >
              <span v-if="product.productStatus === 'online'" class="w-2 h-2 rounded-full bg-green-400 animate-breathe" />
              <span v-else class="i-carbon-time text-sm" />
              {{ product.productStatus === 'online' ? '已上线运营' : product.productStatus === 'developing' ? '开发中' : '规划中' }}
            </div>

            <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight bg-gradient-to-r from-white via-blue-300 to-white bg-clip-text text-transparent animate-text-shimmer">{{ product.title }}</h1>
            ...
            <div class="flex flex-wrap gap-4 justify-center md:justify-start">
              <button
                class="inline-flex items-center gap-2 px-8 py-3 text-lg bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30 shine-on-hover"
              ...
              <button
                ...
                class="group inline-flex items-center gap-2 px-8 py-3 text-lg bg-white text-black border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors"
                @click="handleSecondaryAction"
              >
                <span v-if="product.githubUrl" class="i-carbon-logo-github text-base group-hover:translate-x-1 transition-transform" />
          ...
          <div class="md:w-1/2 flex justify-center">
            <div class="w-full max-w-2xl aspect-video rounded-3xl bg-gradient-to-br from-blue-400 to-purple-400 p-1 shadow-2xl opacity-90 animate-float-soft animate-gradient">
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="grid md:grid-cols-2 gap-16">
          <div>
            ...
            <div class="space-y-4">
              <Reveal
                ...
                width="100%"
              >
                <div class="group flex items-start p-4 rounded-xl bg-white shadow-sm border border-gray-100 hover:border-blue-200 transition-colors">
                  <span class="i-carbon-checkmark-filled text-blue-500 mt-1 mr-4 text-xl shrink-0 group-hover:scale-110 transition-transform" />
                  <div>
          ...
          <div>
            ...
            <div class="bg-slate-900 rounded-2xl p-8 text-gray-300 shine-on-hover">
              <ul class="space-y-6">
                <li v-for="(spec, i) in (product.specs || [])" :key="i" class="border-b border-gray-800 pb-4 last:border-0 last:pb-0">
                  <Reveal variant="right" :delay="0.05 * i" width="100%">
              ...
              <div class="mt-8 pt-6 border-t border-gray-800 text-center">
                <button class="w-full bg-white/10 hover:bg-white/20 text-white rounded-lg py-3 transition-colors shine-on-hover">
                  下载技术白皮书
                </button>
              </div>
            </div>
    ...
    <!-- CTA -->
    <section class="py-24 bg-gradient-to-r from-blue-600 to-indigo-700 text-center text-white animate-gradient">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <button class="bg-white text-blue-700 hover:bg-gray-100 px-10 py-4 rounded-full text-lg font-bold shadow-lg transition-all shine-on-hover hover:scale-105" @click="router.push('/contact')">
          联系销售顾问
        </button>
      </div>
    </section>
